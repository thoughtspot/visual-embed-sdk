...
For all such domain-related customizations, we recommend that you contact the ThoughtSpot Support team. We also recommend that you read the following guidelines before initiating a request for the domain name or URL change.
