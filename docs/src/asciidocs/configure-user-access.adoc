...
For more information about system privileges, see  link:https://docs.thoughtspot.com/software/latest/groups-privileges[Understand groups and privileges, window=_blank].
...
Using link:https://docs.thoughtspot.com/software/latest/security-rls[Row Level Security, window=_blank] (RLS), you can restrict access to sensitive data and filter tables to show only relevant data for the signed-in user.
...
+
For more information, see link:https://docs.thoughtspot.com/software/latest/share-source-tables[Sharing tables and columns, window=_blank].
