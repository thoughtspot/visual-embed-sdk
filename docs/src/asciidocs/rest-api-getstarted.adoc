...
* Using the *REST Playground v1* in the Developer portal (Requires Developer or Admin privilege)
+
If the REST API Playground feature is enabled on your cluster, the UI displays the *REST Playground v2* menu option, on clicking which you can access REST v1 endpoints. 
