...
+
If REST API Playground feature is enabled on your cluster, the UI displays the REST Playground v2 menu option. You can click this link to access the REST v1 endpoints. 
