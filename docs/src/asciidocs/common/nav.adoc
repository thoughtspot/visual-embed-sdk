...
** link:https://try-everywhere.thoughtspot.cloud/external/swagger/[REST API Explorer (Login required), window=_blank]
...
** link:{{previewPrefix}}/external/swagger[REST API Explorer (Login required), window=_blank] 
** link:{{tshost}}/external/swagger[REST API Explorer(Login required), window=_blank]
