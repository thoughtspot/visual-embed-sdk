...
** link:{{navprefix}}=restV1-playground[REST API v1 Playground]
...
** link:{{navprefix}}=v1v2-comparison[Key differences between V1 and V2]
** link:{{navprefix}}=rest-api-v1[REST API V1]
*** link:{{navprefix}}=rest-apiV1-getstarted[Get started]
...
*** link:{{navprefix}}=api-auth-session[Authentication]
*** link:{{navprefix}}=client-libraries[Client libraries]
**** Quickstart - Java 
**** Quickstart - Python 
**** Quickstart - TypeScript
*** link:{{navprefix}}=rest-apiv2-reference[REST API Reference]
*** link:https://try-everywhere.thoughtspot.cloud/v2/#/everywhere/api/rest/playgroundV2[REST API V2 Playground, window=_blank]
