...
|[tag greenBackground]#✓# Supported|[tag greenBackground]#✓# Supported 2*|[tag greenBackground]#✓# Supported
|Wildcard (`*`) for domain URL|[tag greenBackground]#✓# Supported|[tag greenBackground]#✓# Supported| [tag redBackground]#x# Not supported |[tag greyDarkBackground]#x# Not recommended
...
`+++.*.thoughtspot.com +++` |[tag redBackground]#x# Not supported|[tag redBackground]#x# Not supported 2*|[tag greenBackground]#✓# Supported

a|Wildcard before the domain name +

`+++*+++.thoughtspot.com`

|[tag greenBackground]#✓# Supported|[tag greenBackground]#✓# Supported 2*|[tag redBackground]#x# Not supported
...
`thoughtspot.com/products`|[tag greenBackground]#✓# Supported|[tag greenBackground]#✓# Supported 2*|[tag redBackground]#x# Not supported
