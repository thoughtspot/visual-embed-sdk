...
Although you can add a domain name string with protocol and port to the CORS allowlist, ThoughtSpot ignores the port and protocol (`http/https`) in the domain names of CORS hosts.
