...
The following table shows the valid domain name strings to use in the CORS and CSP allowlists. Note that the CORS allowlist ignores the port and protocol in the hostname strings. 
...
|Domain name with wildcard (*) and leading dot +
