...
The Visual Embed SDK now supports passing the custom CSS URL and style customization definitions in the `customizations` property and call it from `init`. For more information, see xref:css-customization.adoc[Customize CSS].
|====
