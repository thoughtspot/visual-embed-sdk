...
The upcoming version of Visual Embed SDK supports `navigate` host event, which is triggered when a user navigates to an application page without a page reload.
