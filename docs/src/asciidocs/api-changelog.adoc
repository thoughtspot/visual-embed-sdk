...
This changelog lists only the changes introduced in the Visual Embed SDK. For a complete list of new features and enhancements, see xref:whats-new.adoc[What's New].
