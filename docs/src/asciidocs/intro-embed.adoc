...
The REST API v2 Playground [beta betaBackground]^Beta^  feature offers several API endpoints and improved functionality to programmatically manage ThoughtSpot objects.
