...
You can access the developer portal from either the ThoughtSpot website, or the *Develop* tab in the ThoughtSpot application. To access the *Develop* tab in the ThoughtSpot application, you must have administrator or developer user privileges.
