...
`authentication_type` [tag greenBackground]#NEW in 8.8.0.cl# a| Type of authentication method to use. Valid values are: +

* SERVICE_ACCOUNT +

Allows using service account to authenticate and access data from the Cloud data warehouse.

* OAUTH +

Allows using OAuth credentials to authenticate
* IAM
* EXTOAUTH
Default value set to SERVICE ACCOUNT.
