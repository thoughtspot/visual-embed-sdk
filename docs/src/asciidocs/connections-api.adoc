...
.Sample response for a single table query
...
.Sample response for a multiple table query
[%collapsible]
====
[source,JSON]
----
...
.Sample response with a table from a specific database
[%collapsible]
====
[source,JSON]
----
...
.Sample response for multi-table query from one or more external databases.
