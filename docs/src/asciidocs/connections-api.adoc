...
====
|`authentication_type` [tag greenBackground]#NEW in 8.8.0.sw# a|__String__. Type of authentication to use when fetching data from the Cloud Data Warehouse. Valid values are: +
