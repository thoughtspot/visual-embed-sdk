...
To create or modify data connections through REST APIs, you must provide a map of JSON attributes as `metadata`. The metadata JSON includes configuration attributes and a map of the database schema with tables.
