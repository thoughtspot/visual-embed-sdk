...
+
++++
<a href="{{tshost}}/#{{appRoot}}/playground/pinboard?modifyActions=true" id="preview-in-playground" target="_blank">Try it in Playground</a>
++++
+
...
+
++++
<a href="{{tshost}}/#{{appRoot}}/playground/pinboard?runtimeFilters=true" id="preview-in-playground" target="_blank">Try it in Playground</a>
++++
...
++++
<a href="{{tshost}}/#{{appRoot}}/playground/pinboard" id="preview-in-playground" target="_blank">Preview in Playground</a>
++++
