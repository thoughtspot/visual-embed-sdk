...
+
++++
<a href="{{tshost}}/#{{appRoot}}/playground/pinboard?modifyActions=true" id="preview-in-playground" target="_parent">Try it in Playground</a>
++++
hiddenActions::
...
+
++++
<a href="{{tshost}}/#{{appRoot}}/playground/pinboard?runtimeFilters=true" id="preview-in-playground" target="_parent">Try it in Playground</a>
++++
...
++++
<a href="{{tshost}}/#{{appRoot}}/playground/pinboard" id="preview-in-playground" target="_parent">Preview in Playground</a>
++++
