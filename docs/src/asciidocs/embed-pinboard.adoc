...
_Array of strings_. Allows adding visualization GUIDs that you want to show by default when a Liveboard renders on your application page for the first time.
+
You can show or hide the visualization by triggering the `SetVisibleVizs` event.
