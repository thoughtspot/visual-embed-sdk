...
+
++++
<a href="{{origin}}/playground/pinboard?modifyActions=true" id="preview-in-playground" target="_parent">Try it in Playground</a>
++++
+
...
+
++++
<a href="{{origin}}/playground/pinboard?runtimeFilters=true" id="preview-in-playground" target="_parent">Try it in Playground</a>
++++
...
++++
<a href="{{origin}}/playground/pinboard" id="preview-in-playground" target="_parent">Preview in Playground</a>
++++
