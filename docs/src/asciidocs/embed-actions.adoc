...
* *Present*
+
Presents the pinboard in a fullscreen mode.

* *Download as PDF*
+
Downloads the pinboard or visualizations in a pinboard as a PDF file.

* *Manage schedules*
+
Allows scheduling and monitoring pinboard jobs.
...
* *Follow*
+
Allows you to follow a pinboard and receive email notifications about the pinboard status and modifications.

* *Share*

+
Allows sharing a pinboard with another or user group.
...
* *Explore* 
+
Allows you to explore answers.

* *Pin*
+
Allows you to pin a visualization to a pinboard.

* SpotIQ analysis
+
Allows you to run SpotIQ analyses. Available as a primary action icon. 

* *Download* 
+
Downloads the visualization data. Available only for charts.
...
* *Download as CSV* 
+
Downloads the visualization data in the CSV file format. Available only for tables.

* *Download as XLSX* 
+
Downloads the visualization data in the XLSX file format. Available only for tables.

* *Download as PDF* 
+
Downloads the visualization data as a PDF file. Available only for tables.


=== Actions for charts and tables
...
== Configure menu actions using Visual Embed SDK
