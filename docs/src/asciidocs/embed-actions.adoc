...
visibleActions::
Allows you to define a list of actions that can be made visible to application users. If your embedded instance requires only a few actions, you can use the `visibleActions` API to add only those actions to the embedded UI.
