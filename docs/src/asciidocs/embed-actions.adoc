...
:page-description: Show or hide actions in embedded Liveboards and visualizations

ThoughtSpot visualization, Liveboards, and answer pages include menu actions that perform various operations. Some of these actions are presented as primary actions on a Liveboard or answer page, whereas some appear as menu items in the *More* menu image:./images/icon-more-10px.png[the more options menu], or the contextual menu that appears when a user right-clicks on a visualization.

== Disable or hide actions in Visual Embed SDK

The Visual Embed SDK allows you to configure menu components for embedded Liveboard and visualization pages. By default, the standard menu actions are *enabled* on all embedded instances. You can disable or hide specific menu actions in the *More* menu image:./images/icon-more-10px.png[the more options menu] or primary action bar in the visualization or Liveboard page.
...
ThoughtSpot embedded instances support the following actions on Liveboards and visualizations.
...
|*Share*|Allows sharing a Liveboard with another user or user group.|`Action.Share`
|*Follow*|Allows you to follow a Liveboard and receive email notifications about the Liveboard status.|`Action.Subscription`
|*Add filters*|
Adds filters to all visualizations in a Liveboard.
|`Action.AddFilter`
|*Configure filters*|Applies filters to a specific visualization in a Liveboard.|`Action.ConfigureFilter`
|*Copy link*| Copies Liveboard link to clipboard.| `Action.CopyLink`
|*Download as PDF*|Downloads the Liveboard or visualizations in a Liveboard as a PDF file.|`Action.DownloadAsPdf`
|*Make a copy*| Creates a copy of the Liveboard.| `Action.MakeACopy`
|*Add schedule*| Adds a Liveboard job schedule.|`Action.SchedulesList`
|*Manage schedules*|Allows scheduling and monitoring Liveboard jobs.|`Action.Schedule`
|*Present*|Presents the Liveboard in fullscreen mode.| `Action.Present`
|*Liveboard info*|Displays information about the Liveboard.|`Action.LiveboardInfo`
|*Save*| Saves the Liveboard.| `Action.Save`
|===

=== Liveboard visualization actions
...
|*Pin*|Pins a visualization to a Liveboard.| `Action.Pin`
...
////
|*Description* | Allows you to add a description to a Liveboard.|`Action.Describe`
////
