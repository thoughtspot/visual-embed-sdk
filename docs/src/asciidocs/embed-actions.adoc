...
Starting from the the 8.0.0.cl release, the **Follow** button is replaced with **Schedule**. You can use either `Action.Schedule` or `Action.Subscription` to show or hide the **Schedule **feature.
...
[IMPORTANT]
====
The *Follow* action is deprecated in the ThoughtSpot 8.0.0.cl release. The corresponding action string, `Action.Subscription` is also deprecated in Visual Embed SDK version 1.6.0.
====
