...
The REST API v2 Playground and SDK is a limited availability feature and is in beta. If you have ThoughtSpot Everywhere Edition license or access to the *Develop* tab, you can visit the Playground and explore the API endpoints.
