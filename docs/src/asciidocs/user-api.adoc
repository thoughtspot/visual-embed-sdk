...
|`orgScope` __Optional__|Query parameter|__String__. The Org scope. If you want to add the user to a specific Org, you must set the Org scope to `ALL`. Applicable to ThoughtSpot Cloud instances only.
|===
=== Example request
...
|`orgScope` __Optional__|Query|__String__. The Org scope. Specify `ALL` to set the Org scope to all Orgs. Applicable to ThoughtSpot Cloud instances only.
|===
...
|`orgid`|Query|__Integer__. Applicable to ThoughtSpot Cloud instances only. The org ID to which the user is associated.
|`orgScope`|Query|__String__. Applicable to ThoughtSpot Cloud instances only. The Org scope. Specify `ALL` to set the Org scope to all Orgs.
|===
=== Example request
