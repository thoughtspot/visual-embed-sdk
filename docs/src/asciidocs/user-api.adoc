...
'http://<ThoughtSpot-host>/callosum/v1/tspublic/v1/user/addtoorg'
----

.Request URL
----
https://<ThoughtSpot-host>/callosum/v1/tspublic/v1/user/addtoorg
----
...
To remove the user from all Orgs and the ThoughtSpot system, specify the `orgid` as `-1`.
