...
|`triggeredbyadmin` |__Boolean__. Indicates if the user creation API request is initiated by the ThoughtSpot administrator or an external application. By default, the `triggeredbyadmin` flag is set to `false`. displayNameLastUpdatedBy

----
"userProperties": {
      "displayNameLastUpdatedBy": "AUTO"
    },
