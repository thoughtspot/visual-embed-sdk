...
* Make sure you specify the usernames or user IDs. If you pass null values in the API call, all user sessions on your cluster becomes invalid and users are forced to re-login. 
====
