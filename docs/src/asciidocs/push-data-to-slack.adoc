...
+
The system prompts you to sign in to your workspace if you haven't already signed in. To continue with the integration, you can log into your workspace with your credentials.
