...
.. Close the app authorization page and return to the ThoughtSpot UI. 
.. Wait until the request is approved by your workspace administrator. You will receive a notification via email and Slackbot when your request is approved.
+
If your request is not approved, you will see the *Your request is already submitted* message when you retry sending data to Slack. Contact your Slack workspace administrator and make sure the app is installed.

.. After you receive the notification from Slackbot or email about the request approval, re-initiate the data push workflow by clicking the app action in the ThoughtSpot UI.
...
. In the app authorization pop-up, specify your Slack workspace.
+
