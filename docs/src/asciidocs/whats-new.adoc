...
In the upcoming version, you can assist your application users with simple search scenarios using Search Assist lessons. If the Search Assist feature is enabled and the Search Assist lessons are created on the embedded instance, users can try sample search scenarios, follow the instructions, and get answers.
