...
|[tag greenBackground]#NEW FEATURE#| ThoughtSpot now provides .NET SDK to allow developers to interact with REST APIs from .NET applications. The SDK can be downloaded from NuGet Package Manager and installed using the NuGet GUI.
