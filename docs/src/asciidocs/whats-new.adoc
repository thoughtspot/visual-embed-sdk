...
The Visual Embed SDK version 1.10.x is now available. For more information about the new features and enhancements introduced in these SDK versions, see xref:api-changelog.adoc[Visual Embed changelog].
...
The 8.2.0.cl release also introduces the following features and enhancements:
