...
If you have set the contextual menu preference to `right-click` in the `ContextMenuTrigger` property, you can register the `EmbedEvent.VizPointRightClick` event to listen to the right-click events on a chart of table.
