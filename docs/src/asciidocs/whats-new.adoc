...
Embedding Search using Visual Embed SDK is fully supported from the 8.4.0-sw release on ThoughtSpot Software instances with the *New Answer experience* enabled.
...
The ThoughtSpot Software 7.2.1 version supports Visual Embed SDK version 1.5.x, which includes the following new features and enhancements.
