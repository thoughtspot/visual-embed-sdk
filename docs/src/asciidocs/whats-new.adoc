...
The Visual Embed SDK version 1.10.0 with the `AddRemoveColumns` event will be available on your instances soon. For more information, see xref:api-changelog.adoc[Visual Embed changelog].
...
The xref:rest-api-v2.adoc[REST API Playground and SDK] feature will be enabled by default on ThoughtSpot instances in the upcoming release.
