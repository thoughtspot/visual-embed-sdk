...
* The `disableProfileAndHelp` attribute to show or hide the Help (?) and the user profile menu in the navigation bar of your embedded app. If you have embedded full ThoughtSpot application with the navigation bar, the Help (?) and the user profile menu icons are enabled by default.
