...
In the upcoming release, you can set up your ThoughtSpot Cloud instance as a multi-tenant cluster and partition it into logical and isolated workspaces called *Orgs*. For more information, see xref:orgs.adoc[Multi-tenancy with Orgs].
