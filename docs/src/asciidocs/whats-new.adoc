...
You can now enable CSP overrides for font, stylesheet, and image sources. If you want to load fonts, stylesheets, image, or favicon from an external source, add the source URLs to the CSP allowlist on the *Security Settings* page in the *Develop* tab. +
