...
=== ThoughtSpot Everywhere Edition License

[width="100%" cols="1,4"]
|====
||
|[tag greenBackground]#New feature# a| *ThoughtSpot Everywhere License*

ThoughtSpot now offers the ThoughtSpot Everywhere Edition license that grants access to ThoughtSpot Everywhere features. With the ThoughtSpot Everywhere Edition license, you can access the Developer portal, Playground, customization workflows, Visual Embed SDK, and REST APIs. 

The ThoughtSpot Everywhere Edition license can be used along with the ThoughtSpot Enterprise Cloud Service subscription. To activate ThoughtSpot Everywhere features on your ThoughtSpot Cloud cluster, you must purchase the ThoughtSpot Everywhere Edition license. 

For more information, see xref:get-started-tse.adoc[Get started with ThoughtSpot Everywhere].

|[tag greenBackground]#New feature# a| *License workflows* 

The new licensing model introduces the following workflows in the ThoughtSpot Developer portal:

* By default, the ThoughtSpot Developer Portal displays a locked icon for the customization features on clusters that _do not_ have the ThoughtSpot Everywhere Edition license. When you click the locked icon, the UI displays a page that prompts you to sign up for a free trial or upgrade your license.

* The ThoughtSpot Enterprise Cloud service subscribers can start a 30-day free trial or initiate license upgrade from the UI.  

* Free trial users can now initiate a license upgrade request by clicking **Upgrade Now** at any time during the evaluation period or when the trial expires.

* On clicking *Upgrade*, ThoughtSpot opens the Live Chat widget to initiate a conversation with the Sales personnel who can assist you with the license upgrade.  
...
[width="100%" cols="1,4"]
|====
|[tag greenBackground]#New feature#  a| Full app 

The Playground for full app now includes the *Hide profile and help* checkbox. When you select this  checkbox, the `disableProfileAndHelp` attribute is 
Full app - Hide profile and help
Pinboard - Full height
|====
...
|====
||
|[tag greenBackground]#New feature# a|**Prefetch API**

The Visual Embed SDK now includes a prefetch API that helps prefetch static resources from a given cluster URL. The prefetched resources are cached locally on web browsers to provide faster access. You can enable the prefetch API call to reduce the response time in rendering embedded objects.

|[tag greenBackground]#New feature# a| *Custom page navigation*
