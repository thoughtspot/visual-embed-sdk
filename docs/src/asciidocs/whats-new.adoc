...
The REST v2 API [beta betaBackground]^Beta^ feature will be deprecated in 9.0.1-sw and replaced with the new REST v2.0 API endpoints. For more information, see xref:deprecated-features.adoc[Deprecation announcements].
