...
You can now assist your application users with simple search scenarios using Search Assist lessons on embedded ThoughtSpot instances. If the Search Assist feature is enabled, and the Search Assist lessons are created on the embedded instance, users can view sample search questions and follow the instructions to get answers.

For more information, see xref:search-assist-tse.adoc[Enable Search Assist, window=_blank].

=== Visual Embed SDK 1.13.0

For information about the upcoming features and enhancements in the Visual Embed SDK version 1.13.0, see xref:api-changelog.adoc[Visual Embed changelog].

=== ThoughtSpot UI

The new Data workspace will be Generally Available (GA) in 8.5.0.cl. For more information about the new Data tab, SpotApps, and other related features, see link:https://docs.thoughtspot.com/cloud/latest/notes[ThoughtSpot product documentation].
