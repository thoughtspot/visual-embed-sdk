...
In the upcoming releases, the REST v2 API [beta blueBackground]^BETA^ feature will be deprecated and replaced with the new REST v2.0 API endpoints. For more information, see xref:deprecated-features.adoc[Deprecation announcements].
