...
The ThoughtSpot Developer Portal displays a locked icon next to the customization menu actions on clusters that _do not_ have the ThoughtSpot Everywhere Edition license. When you click the locked icon, ThoughtSpot prompts you to sign up for a free trial or upgrade your license. 
