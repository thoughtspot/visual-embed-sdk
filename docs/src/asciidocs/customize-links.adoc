...
ThoughtSpot users use system-generated links to access pinboards, visualizations, search answers, and other resources. ThoughtSpot generates these links for various operations and sends them in email notifications. 

Some of the most commonly used links in ThoughtSpot are: 
