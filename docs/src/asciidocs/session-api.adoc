...
|`orgid` a|__Integer__. ID of the Org object. The org ID `0` indicates `Primary Org`. To switch to another Org, specify the Org ID. Applicable to ThoughtSpot Cloud instances only.  +
////
