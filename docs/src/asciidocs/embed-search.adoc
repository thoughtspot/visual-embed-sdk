...
_Boolean_. When set to `true`, it sets the table view as the default view for presenting search results. 
...
----
 ...
 searchEmbed.on(EmbedEvent.AuthExpire, showAuthExpired)
----
