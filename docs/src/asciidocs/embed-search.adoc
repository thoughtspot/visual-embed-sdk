...
_Array of strings_. Disables the specified actions on the search results page. You can use this attribute to restrict user access to certain features.
+
...
_Array of strings_. Hides the specified actions. You can use this attribute to remove the buttons and menu actions that are not relevant to your application context.
