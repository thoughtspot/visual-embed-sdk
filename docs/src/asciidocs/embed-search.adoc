...
For example, to hide the *Show underlying data* action from the *More* menu image:./images/icon-more-10px.png[the more options menu], add `showUnderlyingData` to the  `disabledActions` attribute.
