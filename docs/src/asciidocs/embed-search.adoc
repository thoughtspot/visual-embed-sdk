...
++++
+
For a complete list of action menu items and the corresponding strings to use for disabling menu items, see link:https://visual-embed-sdk.vercel.app/docs/typedoc/enums/action.html[Action, window=_blank].
...
+
For a complete list of action menu items and the corresponding strings to use for disabling or hiding menu items, see link:https://visual-embed-sdk.vercel.app/docs/typedoc/enums/action.html[Action, window=_blank].
...
For a complete list of event types that you can register, see  link:https://visual-embed-sdk.vercel.app/docs/typedoc/enums/embedevent.html[EmbedEvent, window=_blank].
