...
[%collapsible]
====
.Example code for embedded Liveboards
[source,JavaScript]
----
...
.Example code for embedded Answers
[source,JavaScript]
----
appEmbed.trigger(HostEvent.Delete)
----
====
--
...
.Example code for event trigger on embedded Liveboard
...
.Example code for event trigger on embedded visualization
...
.Example code for event trigger on search embed
[source,JavaScript]
----
searchEmbed.trigger(HostEvent.ShowUnderlyingData)
----
...
--
////
.Example code for embedded visualization
