...
<apex:iframe src="https://{thoughtspot-server}/?embedApp=true#/embed/viz/{pinboard_id}/{answer_id}/?col1={field_name}&op1=EQ&val1={!account.Name}" frameborder="0" height="690" width="100%">
</apex:iframe>
</apex:pageBlock>
</apex:page>
----
