= Embed pinboards without the Visual Embed SDK
...
If you want to embed an individual visualization from a pinboard, use the following URL pattern:

`https://{thoughtspotserver}/?embedApp=true#/embed/viz/{pinboard_id}/{visualization_id}`
...
<apex:iframe src="https://{thoughtspot-server}/?embedApp=true#/embed/viz/{pinboard_id}/{visualization_id}/?col1={field_name}&op1=EQ&val1={!account.Name}" frameborder="0" height="690" width="100%">
</apex:iframe>
</apex:pageBlock>
</apex:page>
----
