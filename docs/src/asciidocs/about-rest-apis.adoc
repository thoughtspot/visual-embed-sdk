...
== List of APIs
The following list of APIs are available on the Swagger portal ThoughtSpot users.
...
|====
|Request URL|Description|
`*POST* /tspublic/v1/session/login` |Authenticate and login a user.
...
----
You will get a list of all publicly available REST API services.   
