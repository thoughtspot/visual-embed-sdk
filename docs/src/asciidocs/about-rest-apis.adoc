...
* REST API V2.0
+
The REST API v2 framework provides enhanced functionality and improved API experience with an interactive Playground.
...
ThoughtSpot users with Developer or Administrator privileges can access the REST v1 and v2.0 API endpoints in the *Develop* tab. The portal provides a separate Playground for each REST API version and lets you explore the API endpoints, request and response workflows.
