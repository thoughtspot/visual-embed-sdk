...
== Add React routes (Optional)

If you are building a multi-page app, you can add routes. To create React routes, you must install routing support for your app.

----
ts-data-app> npm add react-router-dom@6
----

After the command is executed, replace the contents of the `index.tsx` file.
...
Add the routes import to the `App.tsx` file in your app directory and create route navigation.
