...
+
__String__. Allows defining a redirect path on which the SAML SSO authentication workflow terminates. If you want to redirect your users to the main page or a specific application page, specify the redirect path as shown here:
