...
|`orgid`|__Integer__. ID of the Org to which the user belongs. This parameter is required if  ThoughtSpot is set as a multi-tenant instance and is logically partitioned into organizations.
|====
