...
Gets a list of all metadata objects from the ThoughtSpot resource repository. a|ThoughtSpot Cloud [version noBackground]#ts7.sep.cl# +
ThoughtSpot Software [version noBackground]#7.2.1# +

__The `authorguid` attribute is available from ThoughtSpot Cloud [version noBackground]#ts8.nov.cl# and ThoughtSpot Software 8.4.0-sw onwards.__
