...
The prefetch API fetches static resources before the application loads. The prefetched resources are then cached the web browsers and served locally to provide faster access to your app.  
