...
Assigns groups to a parent group.|[version noBackground]#8.4.0-sw#
|`xref:group-api.adoc#modifySubgroup[**PUT** /tspublic/v1/group/{groupid}/groups]` +
Updates subgroup objects for a given group.|[version noBackground]#8.4.0-sw#
|`xref:group-api.adoc#get-children[**GET** /tspublic/v1/group/{groupid}/groups]` +
Gets a list of subgroups for a given group object.|[version noBackground]#8.4.0-sw#
|`xref:group-api.adoc#addMembers[**POST** /tspublic/v1/group/addmemberships]` +
Adds members to a group.| [version noBackground]#8.4.0-sw#
|`xref:group-api.adoc#removeMembers[**POST** /tspublic/v1/group/removememberships]` +
Removes members from a group.|[version noBackground]#8.4.0-sw#
|`xref:group-api.adoc#del-child-groups[**DELETE** /tspublic/v1/group/{groupid}/groups]` +
Removes subgroups from a group.|[version noBackground]#8.4.0-sw#
