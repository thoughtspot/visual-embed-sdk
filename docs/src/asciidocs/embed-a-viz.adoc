...
This page explains how to embed a single ThoughtSpot visualization, such as a table or chart, in your Web page, portal, or application. A visualization is one single answer on a Liveboard, displayed without the search bar or other options to change the visualization.
