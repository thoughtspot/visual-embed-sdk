...
+
For a complete list of action menu items and the corresponding strings to use for hiding menu items, see link:https://visual-embed-sdk.vercel.app/docs/typedoc/enums/action.html[Action, window=_blank].
