...
A visualization is a single answer pinned to a Liveboard. Pinned visualizations appear without the search bar or the other options to change the visualization.
...
[NOTE]
====
* If you want to display multiple charts or tables that have been saved in a Liveboard, try to embed a single pinboard rather than multiple individual visualizations. This helps in improving your application performance.
