...
This page explains how to embed a single ThoughtSpot visualization in your Web page, portal, or application. A visualization is one single answer on a pinboard, displayed without the search bar or other options to change the visualization.
