...
+
++++
<a href="{{tshost}}/#{{appRoot}}/playground/answer?modifyActions=true" id="preview-in-playground" target="_parent">Try it in Playground</a>
++++
...
+
++++
<a href="{{tshost}}/#{{appRoot}}/playground/answer?runtimeFilters=true" id="preview-in-playground" target="_parent">Try it in Playground</a>
++++
...
++++
<a href="{{tshost}}/#{{appRoot}}/playground/answer" id="preview-in-playground" target="_parent">Preview in Playground</a>
++++
