...
:page-description: You can use the PinboardEmbed SDK library to embed visualizations on a pinboard and view them in your application context.

This article explains how to embed a single ThoughtSpot visualization in your Web page, portal, or application.

A visualization is a single answer pinned to a pinboard. Pinned visualizations appear without the search bar or other options to change the visualization.
