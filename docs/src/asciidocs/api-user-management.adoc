...
|Name of the principal|This field, in conjunction with whether the object is a user or group, is used to identify a user or group. The name of the prinicipal must be unique. 
...
|`groupNames`|Name of the groups to whic a principal belongs. Groups and users can belong to other groups. 
|====
