...
The following table lists the authentication methods that you can use to authenticate users on an embedded instance and general recommendations for choosing an authentication method for your app.
...
* If you have access to your IdP settings to allow iframe embedding and configure redirects
