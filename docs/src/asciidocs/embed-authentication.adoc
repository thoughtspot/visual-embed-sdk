...
a|ThoughtSpot does not recommend using passthrough authentication in the following scenarios: +
...
* You do not have access to your OpenID provider server to configure it for passthrough authentication.
a|ThoughtSpot does not recommend this method: +
...
* If your IdP setup does not support passthrough authentication.
...
* If you want to implement a simple solution with passthrough authentication.
...
[IMPORTANT]
====
For production environments, ThoughtSpot strongly recommends using SAML SSO, OIDC, passthrough, or trusted authentication.
====
...
ThoughtSpot recommends passthrough authentication, because it simplifies the authentication process for embedded applications. With passthrough authentication, you can leverage your existing IdP setup and configure it to support your embedded instance. All you need to do is to configure SAML or OIDC authentication support on ThoughtSpot and set up redirects to your IdP for seamless user authentication.
...
[Note]
====
The passthrough authentication feature is similar to the `No authentication` method supported in the SDK. If you have set `authType` as `AuthType.None`, the SDK considers it as passthrough authentication and allows your embedded application to use your current IdP configuration and redirect rules.
====
