...
|xref:metadata-api.adoc[Metadata API endpoints] +

* __Require at least view access to metadata objects__ +
* __ `POST` requests require authentication__|[tag greenBackground]#✓# |[tag greenBackground]#✓# |[tag greenBackground]#✓# |[tag greenBackground]#✓#
...
__Require authentication__ +
__Require edit access to metadata objects__|[tag greenBackground]#✓# |[tag greenBackground]#✓#|[tag greenBackground]#✓#|[tag greyBackground]#–#
...
__Require authentication__|[tag greenBackground]#✓# |[tag greenBackground]#✓#|[tag greenBackground]#✓#|[tag greyBackground]#–#
...
* __Require at least view access to metadata objects__ +
* __ `POST` and `PUT` requests require authentication__ +
...
* __Require authentication__ +
* __You must have edit access to metadata objects to share and view permission details__ |
[tag greenBackground]#✓# |[tag greenBackground]#✓# |[tag greenBackground]#✓# |[tag greyBackground]#–#
a|Logs API endpoint +
__Requires `ADMINISTRATION` privilege__|[tag greenBackground]#✓# |[tag greenBackground]#✓#|[tag greyBackground]#–# |[tag greyBackground]#–#|
|=====
