...
a|Creating an app with ThoughtSpot content using Visual Embed SDK
...
(Applicable to embedded ThoughtSpot instances) a|
...
|App actions for business app integration
