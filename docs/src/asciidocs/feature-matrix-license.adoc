...
a|xref:feature-matrix-license.adoc#_rest_api_v2beta_bluebackgroundbeta_availability[REST API v2] [beta betaBackground]^Beta^  |[tag greenBackground]#✓#  +
(Basic authentication only) |[tag greenBackground]#✓# |[tag greenBackground]#✓#  +
(Basic authentication only) |[tag greyBackground]#–#
