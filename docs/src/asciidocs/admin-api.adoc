...
|`tags`|__String__. A JSON array of tag GUIDs. If tags are applied to worksheets, search answers, or pinboard visualizations, and custom actions are associated to these objects, you can use this parameter to filter the custom action data by tags.
|====
