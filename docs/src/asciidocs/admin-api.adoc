...
* The `Accept` header set as `Accept: application/json`
* The `X-requested-by` header must be `X-Requested-By: ThoughtSpot`
* The Content-Type set as `application/x-www-form-urlencoded`
...
* The `Accept` header as `Accept: text/html`
...
[
  {
    ...
    "detail": {
      ...
      "apiKey": "X-API-KEY",
      "apiValue": "",
      "additionalUrlHeaders": "{\"url_header1\":{\"id\":\"b7640ef3-0966-4f7e-b06e-a6775bebacb2\",\"key\":\"wwwwwww\",\"value\":\"andreea\"},\"url_header2\":{\"id\":\"bf53da76-688c-4bda-84b0-16d8be95e0e6\",\"key\":\"zzzzzzzzzz\",\"value\":\"test\"}}"
    },
    "context": "NONE",
    "availability": [
      "GLOBAL"
...
* The `Accept` header as `Accept: application/json`
* The `X-requested-by` header as `X-Requested-By: ThoughtSpot`
...
To programmatically create custom actions on ThoughtSpot clusters that support embedding configuration, send a `POST` request with action configurtion details to the `/tspublic/v1/admin/embed/actions` API endpoint.
