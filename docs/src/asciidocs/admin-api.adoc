...
-d 'configchanges=@import-embed-objects-b.json' 'https://<ThoughtSpot-host>/callosum/v1/tspublic/v1/admin/configinfo/update'
----
...
curl -X DELETE \
--header 'Accept: application/json' \
--header 'X-Requested-By: ThoughtSpot' 'https://<ThoughtSpot-host>/callosum/v1/tspublic/v1/admin/embed/actions/0f1b18f9-2dbd-4742-bc70-7bfc1322ad3f'
----
