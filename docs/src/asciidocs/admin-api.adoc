...
--header 'Accept: application/json' \
--header 'X-Requested-By: ThoughtSpot' \
--d 'embedaction={ "id":"3f7eac93-cce1-4ffc-b7a8-429353edbc6b", "name":"Send Survey", "version":"v2", "type":"URL", "detail":{  "link":"https://unpkg.com",  "function":"send-survey", "authSelect":"BEARER",  "authToken":"asdfasadf3q4534534", "encodeUser":"",   "apiKey":"X-API-KEY", "apiValue":"",  "additionalUrlHeaders":"{\"url_header1\":{\"id\":\"6a82908c-9328-40ff-b347-65adeda12f57\",\"key\":\"key1\",\"value\":\"value1\"}}"  },     "actionAssociationMap":{ "ANSWER":{  "e4079d3f-ae71-4b0a-a70a-f17ecaf157a5":{ "enabled":"true", "context":"MENU" } } },  "context":"NONE", "availability":[         "GLOBAL" ], "userGroupList":[ "d0326b56-ef23-4c8a-8327-a30e99bcc72b"  ] } \
'https://<ThoughtSpot-host>/callosum/v1/tspublic/v1/admin/embed/actions'
----
...
--header 'Accept: application/json' \
--header 'X-Requested-By: ThoughtSpot' \
-d 'embedaction=={ "id": "0f1b18f9-2dbd-4742-bc70-7bfc1322ad3f", "name": "Send email", "version": "v2", "type": "CALLBACK", "detail": {  "link": "",     "function": "send-email",  "authSelect": "NONE",  "authToken": "",  "encodeUser": "",  "apiKey": "X-API-KEY",  "apiValue": "", "additionalUrlHeaders": "{}"   },  "context": "NONE",  "availability": [ "LOCAL" ] }' \
