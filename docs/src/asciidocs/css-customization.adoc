...
/******** App ********/
  ...
  /* App wide button design for smaller buttons. For example, share, favorite*/
  --ts-var-button--icon-border-radius: 5px;

  /* Primary buttons: For example, the Pin and Save button on a search results page */
  ...
  /* Tertiary buttons. For example, the Undo, Redo buttons on the Answer pages*/
