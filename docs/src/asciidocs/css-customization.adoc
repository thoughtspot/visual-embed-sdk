...
The `rules` option in the `customCSS` object allows you to apply style overrides to the UI components and elements that cannot be customized using the variables provided by ThoughtSpot.
