...
|`--ts-var-root-text-transform`|Text transformation specification for all UI elements in the app. +
|======
...
=== Search bar and data panel customization
...
|`--ts-var-button--primary-color`|Primary button|
...
=== Charts and visualization style customization

[width="100%" cols="7,7"]
[options='header']
|======
|Variable|Description
`--ts-var-answer-chart-select-background`|Background color of the selected chart type in the chart selection widget that appears on clicking the chart icon image:./images/icon-more-10px.png[Chart selection icon].
|`--ts-var-viz-title-color`|
Font color of the title text of a visualization or answer.
|`--ts-var-viz-title-font-family`|Title text of a visualization/answer|
Font family specification for the title text of a visualization/answer.
|`--ts-var-viz-title-text-transform`|Title text of a visualization/answer|
Text transformation specification for visualization and answer titles.
|`--ts-var-viz-description-color`|Visualization/answer description and subtitle |
Font color of the description text and subtitle of a visualization or answer.
|`--ts-var-viz-description-font-family`|Visualization/answer description and subtitle|
Font family specification of description text and subtitle of a visualization or answer.
|`--ts-var-viz-description-text-transform`|Visualization/answer description and subtitle|
...
|======
|Variable|Element type|Description
|`--ts-var-answer-chart-select-background`|Chart|
|`--ts-var-answer-chart-hover-background`|Chart|
|-ts-var-viz-title-color:|
||
|======
...
----
    "--ts-var-search-bar-text-font-color": "#163772",
    "--ts-var-search-bar-text-font-family": "initial",
    "--ts-var-search-bar-text-font-style": "italic",
----
