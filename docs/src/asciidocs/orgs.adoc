...
__Starting from 9.0.0.cl, Cluster administrators can share connections with Org administrators. Org administrators cannot edit the connections created by the Cluster administrators unless it is shared with them__.
