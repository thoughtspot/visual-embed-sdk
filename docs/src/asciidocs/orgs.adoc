...
__SAML and OIDC group synchronization features are not supported at the All Orgs level__ a| [tag greenBackground]#✓#  Local authentication of clients +

[tag greenBackground]#✓#  Trusted authentication (on embedded instances) +
