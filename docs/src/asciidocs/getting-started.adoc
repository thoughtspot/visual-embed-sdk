...
The latest version of the Visual Embed SDK is available at link://www.npmjs.com/package/ts-embed-sdk[https://www.npmjs.com/package/ts-embed-sdk, window=_blank].
