...
The `tspublic/v1/dependency` endpoints allow you to query the dependency details of objects and associate objects as dependents.
...
[div boxHalfWidth] 
--
image::./images/dependency.png[Dependent objects, scaledwidth=25%]
--
