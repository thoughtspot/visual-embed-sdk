...
* For a complete list of event types, see  link:https://developers.thoughtspot.com/docs/typedoc/enums/EmbedEvent.html[EmbedEvent, window=_blank] and link:https://developers.thoughtspot.com/docs/typedoc/enums/HostEvent.html[HostEvent, window=_blank] SDK documentation.
