...
:page-description: You can get started with ThoughtSpot Everywhere by visiting the Live Playground, signing up for free trial, or by purchasing a ThoughtSpot Everywhere Edition license.
...
However, if you want to explore or evaluate the overall embedding and API experience before acquiring a license, you can xref:get-started-tse.adoc#live-playground[get started with the Live Playground] or xref:get-started-tse.adoc##free-trial[sign up for a Free Trial].

* The Live Playground provides an instant view of the embedding possibilities and interactive coding experience. You can try embedding the  ThoughtSpot application or its features in a sample app and get a quick preview of the developer experience. 
...
[#live-playground]
== Get started with Live Playground
...
. In the Live Playground, click *Sign Up* or click on any locked feature.
