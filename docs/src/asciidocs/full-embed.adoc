...
+
++++
<a href="{{origin}}/playground/fullApp?pageId=search" id="preview-in-playground" target="_blank">Preview in Playground</a>
++++
...
++++
<a href="{{origin}}/playground/fullApp" id="preview-in-playground" target="_blank">Preview in Playground</a>
++++
