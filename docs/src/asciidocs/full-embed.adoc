...
__Array of Strings__. Hides the specified objects. For example, if you do not your application users to view certain pinboards, you can specify the GUIDs of the pinboards in the `hideObjects` attribute.
