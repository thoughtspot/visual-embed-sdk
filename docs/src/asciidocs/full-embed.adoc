...
Full app embedding gives you all the features of ThoughtSpot, along with the ability to use additional features and customization from the Visual Embed SDK, such as custom actions and CSS styling rules. 
