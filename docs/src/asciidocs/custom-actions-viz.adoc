...
If custom actions are added on your instance, the UI displays these actions in the *Custom actions* panel. The *Custom actions* panel allows authorized users to  perform the following tasks:
...
To edit the position of a local custom action associated to an answer or visualization:
