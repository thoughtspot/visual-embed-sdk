...
Both v1 and v2 REST API frameworks allow you to access, retrieve, create, and manage ThoughtSpot objects and resources. REST API v2 is a new framework with that expands the core API functionality with additional features and benefits. 
...
See xref:rest-apiv2-reference.adoc[REST API v2 Reference] for a complete list of endpoints.
