...
The Swagger UI is also accessible via API Playground|Interactive Playground in the Developer portal
...
You can also download Liveboard and Answer data in PDF, PNG, CSV, or XLS format. +
