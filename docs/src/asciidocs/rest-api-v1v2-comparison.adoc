...
[options='header']
|=====
|Feature|REST API v1| REST API v2
...
[options='header']
|=====
|API service|REST API v1| REST API v2
a|*Admin services* +
API endpoints for cluster-level administration | [tag greenBackground]#✓# Available| [tag greenBackground]#✓# Available +
__Available under *system* category__ +
__The current release supports only query APIs__.

|*Authentication* +
API endpoints for user login, authentication, and session management|[tag greenBackground]#✓# Available +
__The login, authentication, token generation, amd logout services are available under *session*__.
...
__The dependent object querying is supported in metadata APIs__.|[tag greenBackground]#✓# Available| [tag greenBackground]#✓# Available
...
__The metadata API service does not support deleting metadata objects and fetching SQL query information from Answer and Liveboard objects__|[tag greenBackground]#✓# Available +
__Includes API services for importing and exporting TML representation of metadata objects such as Liveboard, Worksheets, and Answers.__

|*Orgs* +
API endpoints for Org administration and management | [tag greenBackground]#✓# Available |[tag greenBackground]#✓# Available

|*Reports* +
API endpoints for downloading Liveboards and Answers in the PDF, PNG, XLS, and CSV format.| [tag greenBackground]#✓# Available +
...
__The login, authentication, token generation, and logout services are available in *session* collection and under the *Authentication* category in the Playground__.
...
|*System* +
API endpoints for querying system information |[tag greenBackground]#✓# Available +
__The system administration API operations are available as *Admin services*|[tag greenBackground]#✓# Available
...
* xref:rest-api-v2.adoc[REST API v2]
