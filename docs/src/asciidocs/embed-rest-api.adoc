...
You can use the REST API to get an object from ThoughtSpot and embed it in a web page, portal, or application. ThoughtSpot provides an embed link for objects, such as Liveboards and Liveboard visualizations, using which you can construct the URL required to make an API call.
...
+
To embed a Liveboard, click the ellipses, click the *More* menu image:./images/icon-more-10px.png[the more options menu], and select *Copy embed link*.
