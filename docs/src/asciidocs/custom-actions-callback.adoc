...
For more information about how to push data to an external application using a callback custom action, see xref:push-data-to-external-app.adoc[Push data using a callback custom action].