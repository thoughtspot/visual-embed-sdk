...
|`emailshares`|string|The email address of the user accounts with whom you want to share the objects. If no address is specified, the objects are shared with all users in `ALL_GROUP`.
