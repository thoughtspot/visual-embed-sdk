...
To view object permissions, send a `GET` request to the `/tspublic/v1/security/metadata/permissions` endpoint.
...
If the data query operation is successful, the API returns permission details for the specified object IDs and types.
