...
Starting from the 8.4.0-sw release (Limited Availability), ThoughtSpot Software customers licensed to embed ThoughtSpot can use ThoughtSpot Everywhere features and Visual Embed SDK.
