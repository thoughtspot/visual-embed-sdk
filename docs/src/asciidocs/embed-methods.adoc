...
--
Starting from 8.4.1-sw release, ThoughtSpot Software clusters support ThoughtSpot Everywhere and Visual Embed SDK. For more information, see xref:rel-page-sw.adoc[Now available on ThoughtSpot Software].
--
