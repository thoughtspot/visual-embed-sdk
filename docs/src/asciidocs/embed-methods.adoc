...
Starting from 8.4.0-sw (Limited Availability release), you can use ThoughtSpot Everywhere features and Visual Embed SDK to embed  ThoughtSpot in your applications.
...
s|When to use|The SDK Supports all embed and customization use cases. Use it if your host platform allows custom Javascript.
...
Show or hide UI menu options| [tag greenBackground]#✓#| [tag greyBackground]#–#|[tag greyBackground]#–#|
