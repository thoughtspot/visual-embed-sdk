...
:page-title: Use REST Playground v1 
:page-pageid: rest-v1-playground
:page-description: Use the REST Playground v1 menu to access the v1 endpoints available on your ThoughtSpot cluster.
...
== Access REST v1 explorer

You can access the REST v1 explorer using one of the following options:

* REST v1 Playground in the Developer portal (Requires Developer or Admin privilege)
+
