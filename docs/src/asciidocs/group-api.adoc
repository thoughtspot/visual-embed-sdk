...
|`orgid` +
__Optional__ |__Integer__. ID of the Org. This attribute applies to multi-tenant ThoughtSpot instances only. The Org ID must be the same as the Org context from which the administrator makes an API call.
|===
