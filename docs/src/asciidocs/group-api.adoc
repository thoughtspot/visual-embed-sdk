...
|`orgid` |_-Integer__. ID of the organization to which you want to map the group. You can define this attribute if ThoughtSpot is set as a multi-tenant instance and is logically partitioned into organizations.
|===
