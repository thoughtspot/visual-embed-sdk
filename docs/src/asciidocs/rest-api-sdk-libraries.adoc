...
<div class="row">
    <div class="col-md-3">
       <div class="boxDiv"> <h4 align=center>Java SDK and libraries ^BETA^</h4>
    ...
    <div class="col-md-3">
       <div class="boxDiv"> <h4 align=center>Python SDK and libraries ^BETA^</h4>
    ...
    <div class="col-md-3">
       <div class="boxDiv"> <h4 align=center>Typescript SDK and libraries ^BETA^</h4>
    ...
    <div class="col-md-3">
       <div class="boxDiv"> <h4 align=center>.NET SDK and libraries ^BETA^</h4>
