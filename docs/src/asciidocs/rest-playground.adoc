...
* To explore REST v2 endpoints, and download the SDK and client libraries, click **REST Playground v2**.


== REST API v1 Playground

The REST Playground v1 opens the v1 API explorer and displays the available resource collections.  

To make an API call and view results:

. Click the API service category to view a list of endpoints.
...
The REST API v2 Playground displays a list of v2 endpoints, code explorer to try out the API calls, and language-specific and client libraries. 
...
For more information, see xref:rest-api-v2-playground[REST API V2 Playground].
