...
* To explore REST v2 endpoints, click **REST Playground v2.0**.
...
The REST API v2.0 Playground displays a list of v2 endpoints, and a code panel to try out API calls.
