...
* To explore REST v2[beta betaBackground]^Beta^  endpoints, click **REST Playground v2**.
...
== REST API v2 Playground [beta betaBackground]^Beta^

The xref:rest-api-v2-playground.adoc[REST API v2 Playground][beta betaBackground]^Beta^  displays a list of v2 endpoints and code panel to try out API calls.
