...
Starting from the ThoughtSpot 8.10.0.cl, ThoughtSpot will deprecate the REST v2 API [beta betaBackground]^Beta^ endpoints and introduce the new REST v2.0 API endpoints. +
