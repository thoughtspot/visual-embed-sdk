...
ThoughtSpot recommends that you use the SAML SSO or trusted authentication service to authenticate users for embedding scenarios. 
...
To manage ThoughtSpot user sessions, use the session REST API.
