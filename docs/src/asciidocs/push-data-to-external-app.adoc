...
The ThoughtSpot REST API service allows you push data to third-party application from the ThoughtSpot application context. 

For example, if your client application has embedded the ThoughtSpot search functionality, you can initiate an action to send a search answer to another application or a workflow. To do this, you can use the custom menu item configured for your embedded instance and the REST API. 
