...
Learn how to xref:custom-actions-viz.adoc[assign a custom action to a specific visualization] in an answer or Liveboard.

_Requires edit privileges to modify an answer or a visualization in a Liveboard_.
--
...
View examples of the xref:callback-response-payload.adoc[custom action response payload] with search and Liveboard data.
--
