...
++++
  ...
  <div class="col-md-4">
      <div class="boxDiv">
<p> Explore our guides and code examples to build interactive data apps with ThoughtSpot Visual Embed SDK and REST APIs. </p>
<p> </p>
...
<p>  <a href="?pageid=visual-embed-sdk"> Get started with Visual Embed SDK -></a>
 ...
 <div class="col-md-4">
         <div class="boxDiv">
<p>
Use our REST APIs to query, import or export data, manage users and sessions, and automate deployments. </p>
