...
. To define which user groups can access the custom action, click *Show advanced availability settings*, and select the user groups. By default, the custom action will be accessible to all users.
