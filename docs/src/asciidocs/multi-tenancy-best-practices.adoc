...
ThoughtSpot recommends using Orgs for multi-tenancy. If you do not have this feature enabled on your instance and do not want to create Orgs, you can use the following options:
