...
ThoughtSpot 8.8.1-sw release version is now generally available. To upgrade your ThoughtSpot cluster to 8.8.0-sw, contact ThoughtSpot Support.
...
This release introduces the new Liveboard experience [beta blueBackground]^BETA^ on ThoughtSpot instances. The new Liveboard experience is in Beta on embedded instances and is turned off by default.
