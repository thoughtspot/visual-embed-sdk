...
Sharing visibility::
Specify if users can share objects with this group. When set to `SHARABLE`, ThoughtSpot allows other users to share objects with the members of this group.
Description::
...
Sharing visibility::
Specify if other users can share objects with this user. When set to *SHARABLE*, this user is visible in the *Share* dialog when another user tries to share an object.
Change password::
