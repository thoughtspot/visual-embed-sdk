...
If you set the `export_fqn` attribute to `true`, the API returns the object data with `fqn` IDs, which you can use when uploading the TML file back into ThoughtSpot.
