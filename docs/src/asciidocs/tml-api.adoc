...
[width="100%" cols="1,2"]
|===
|`xref:tml-api.adoc#export[POST /tspublic/v1/metadata/tml/import]`|Validates and imports TML objects.
...
|`import_objects`|string  a|An `x-www-form-urlencoded` string containing a JSON array of strings of TML objects to upload, in YAML or JSON format. 
