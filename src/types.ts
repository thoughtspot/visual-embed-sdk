...
export enum Param {
    ...
    DisableChatConnectorResources = 'disableChatConnectorResources',
    DisableChatConnectors = 'disableChatConnectors',
    DisableChatModeSwitcher = 'disableChatModeSwitcher',
    HideChatConnectorResources = 'hideChatConnectorResources',
    HideChatConnectors = 'hideChatConnectors',
    HideChatModeSwitcher = 'hideChatModeSwitcher',
