...
describe('ConversationEmbed', () => {
    ...
    it('should render the conversation embed with spotterChatWidth', async () => {
        const viewConfig: SpotterEmbedViewConfig = {
            worksheetId: 'worksheetId',
            searchOptions: {
                searchQuery: 'searchQuery',
        ...
        expectUrlMatchesWithParams(
            getIFrameSrc(),
            `http://${thoughtSpotHost}/v2/?${defaultParams}&isSpotterExperienceEnabled=true&spotterChatWidth=500px#/embed/insights/conv-assist?worksheet=worksheetId&query=searchQuery`,
        );
    });
