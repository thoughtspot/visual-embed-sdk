import {
  ...
  getCustomisations,
  getRuntimeFilters,
  getDOMNode, getQueryParamString, setStyleProperties,
...
import {
  ...
  Param,
  EmbedConfig,
  MessageOptions, MessageCallbackObj,
  ViewConfig, ContextMenuTriggerOptions
} from '../types';
...
export class TsEmbed {
  ...
  protected getBaseQueryParams(queryParams = {}) {
    ...
    const {
      disabledActions, disabledActionReason, hiddenActions, visibleActions, hiddenTabs, visibleTabs, showAlerts, additionalFlags, locale, customizations, contextMenuTrigger, linkOverride, insertInToSlide, hideLiveboardHeader, showLiveboardDescription, showLiveboardTitle,
    } = this.viewConfig;
