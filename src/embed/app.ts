...
export class AppEmbed extends V1Embed {
    ...
    private setIframeHeightForNonEmbedLiveboard = (data: MessagePayload) => {
        ...
        const liveboardRelatedRoutes = [
            ...
            // within Spotter resets the frame to defaultHeight, clobbering the
            // fullHeight layout both on initial route (the bare route has no
            // trailing segment, e.g. "/insights/conv-assist") and again
            // mid-stream, when the conversation gets a real id and the URL is
            // updated to "/insights/conv-assist/s/{id}".
