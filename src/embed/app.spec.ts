...
describe('App embed tests', () => {
    ...
    test('Should add navigationVersion=v3 when primaryNavbarVersion is V3 to the iframe src', async () => {
        const appEmbed = new AppEmbed(getRootEl(), {
            ...defaultViewConfig,
            discoveryExperience: {
                primaryNavbarVersion: PrimaryNavbarVersion.V3,
                homePage: HomePage.V2,
            },
        } as AppViewConfig);
    ...
    test('Should add navigationVersion=v3 & modularHomeExperience=false when primaryNavbarVersion is V3 & homePage is V3 to the iframe src', async () => {
        const appEmbed = new AppEmbed(getRootEl(), {
            ...defaultViewConfig,
            discoveryExperience: {
                primaryNavbarVersion: PrimaryNavbarVersion.V3,
