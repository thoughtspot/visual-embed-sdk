...
const styles: Record<string, React.CSSProperties> = {
    ...
    headerSubtitle: {
        fontSize: 11, color: '#8b949e', display: 'flex', alignItems: 'center', gap: 5, marginTop: 1,
    },
    statusDot: {
        width: 6, height: 6, borderRadius: '50%', display: 'inline-block',
    },
    closeBtn: {
        background: 'transparent', border: 'none', color: '#8b949e', cursor: 'pointer', fontSize: 15, padding: 4,
    },
    messages: {
        flex: '1 1 auto',
        minHeight: 0,
    ...
    welcomeTitle: { color: '#e6edf3', fontWeight: 600, fontSize: 15 },
    ...
    elementChipTag: {
        fontFamily: MONO, color: '#6ea8fe', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap',
    },
    elementChipMeta: { color: '#8b949e', flexShrink: 0 },
    elementChipRemove: {
        background: 'transparent', border: 'none', color: '#8b949e', cursor: 'pointer', fontSize: 11, marginLeft: 'auto', padding: 0,
    },
    toolbar: {
